      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{
            ...
            background: "linear-gradient(135deg, #0866FF, #00C6FF)",
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 20, boxShadow: "0 4px 12px rgba(8,102,255,0.4)",
          }}>🚀</div>
          <div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          {status.logado ? (
            ...
            <a href={`${API}/auth/meta`} style={{
              ...
              boxShadow: "0 4px 14px rgba(8,102,255,0.4)",
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              boxShadow: input.trim() && !loading ? "0 4px 12px rgba(8,102,255,0.35)" : "none",
            }}
          >↑</button>
        </div>
